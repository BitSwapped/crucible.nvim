...
function M.get(theme)
	...
	return {
		...
		CursorLineNr = { fg = syn.indigo, bold = true },
		...
		PmenuSel = { fg = ui.fg_alt, bg = ui.pmenu_sel, bold = true },
		...
		WildMenu = { fg = syn.indigo, bg = ui.base3 },
		...
		--  Matching brackets
		MatchParen = { fg = syn.cyan, bold = true, underline = true, sp = syn.red },
