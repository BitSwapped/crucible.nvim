...
---@param bg string|nil fallback blend target, defaults to M.bg
---@param amount number 0.0 = unchanged, 1.0 = black
---@return string
function M.darken(hex, bg, amount)
	return M.blend(hex, bg or M.bg, math.abs(amount))
end

--- Lighten a hex color by blending toward white.
---@param hex string    hex color
---@param fg string|nil fallback blend target, defaults to M.fg
---@param amount number 0.0 = unchanged, 1.0 = white
---@return string
function M.lighten(hex, fg, amount)
